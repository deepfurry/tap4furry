...
| 阶段 1.2～2.2 / P0-3～P0-6 其余能力 | 待完成 | 完整贡献类型、举报治理、搜索发现、收藏整理 |
...
**状态：1.1 已完成，下一步进入 1.2。目标：用户能贡献，运营能审核、追踪和处理问题。**
...
该文档覆盖三个子阶段；1.1 已按[基础贡献审核规格](../implementation/p0-3a-basic-contribution-review.md)完成前后端与验收。1.2 集中补齐其余贡献类型，不为每种提议另开一个项目。
